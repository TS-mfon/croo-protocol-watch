...
Independent CROO production agent. Price: **0.50 USDC**.
...
npm run check
npm run dev
curl -X POST http://localhost:3000/v1/analyze -H 'content-type: application/json' -d '{"chain":"base","protocol":"Test","contracts":["0x1111111111111111111111111111111111111111"],"lookback_blocks":100}'
```
